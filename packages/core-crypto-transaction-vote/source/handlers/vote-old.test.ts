...
// 		context.app = new Application(new)
...
// 	// 	await assert.rejects(() => context.handler.bootstrap(), Exceptions.AlreadyVotedError);
// 	// });
...
// 	// 	await assert.rejects(() => context.handler.bootstrap(), Exceptions.NoVoteError);
// 	// });
...
// 	// 	await assert.rejects(() => context.handler.bootstrap(), Exceptions.UnvoteMismatchError);
// 	// });
...
// 	// 	assert.rejects(() => context.handler.throwIfCannotEnterPool(context.voteTransaction), Exceptions.PoolError);
// 	// });
...
// 	// 	assert.rejects(() => context.handler.apply(context.voteTransaction), Exceptions.AlreadyVotedError);
// 	// 	assert.defined(context.senderWallet.getAttribute("vote"));
// 	// });
...
// 	// 	assert.rejects(() => context.handler.apply(context.voteUnvoteTransaction), Exceptions.AlreadyVotedError);
// 	// });
...
// 	// 	assert.rejects(() => context.handler.apply(context.unvoteUnvoteTransaction), Exceptions.NoVoteError);
// 	// });
...
// 	// 	assert.rejects(() => context.handler.apply(context.unvoteUnvoteTransaction), Exceptions.UnvoteMismatchError);
// 	// });
