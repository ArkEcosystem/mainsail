import { Contracts as ApiDatabaseContracts, Models, Identifiers as ApiDatabaseIdentifiers } from "@mainsail/api-database";
...
export class Mempool extends AbstractListener<Contracts.Crypto.ITransactionData, Models.MempoolTransaction> {
    ...
    protected makeEntityRepository(dataSource: ApiDatabaseContracts.RepositoryDataSource): ApiDatabaseContracts.Repository<Models.MempoolTransaction> {
