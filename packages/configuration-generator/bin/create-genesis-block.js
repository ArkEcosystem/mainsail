...
const configurations = [
	...
	// 			const target = path.join(__dirname, "..", "..", "..", "tests", "functional", "transaction-pool-api", "paths", "config", file);
	...
	// 			const source = path.join(location, file);
	// 			const target = path.join(__dirname, "..", "..", "..", "tests", "e2e", "clients", "config", "core", file);
	// 			copyFileSync(source, target);
	// 		}
	...
	// 			const source = path.join(location, file);
	// 			const target = path.join(__dirname, "..", "..", "..", "tests", "e2e", "consensus", "nodes", `api-node`, "core", file);
	// 			copyFileSync(source, target);
	// 		}
	// 	}
	// },
	...
	// 			const target = path.join(__dirname, "..", "..", "..", "tests", "e2e", "snapshot", "nodes", `node${i}`, "core", "crypto.json");
	// 			copyFileSync(source, target);
	// 		}
	// 	}
	// },
