...
export default {
	...
	totalAmount: BigNumber.make("10500000000"),
	totalFee: BigNumber.make("70000000"),
	...
	transactions: [
		...
		},
		{
			...
			senderPublicKey: "03287bfebba4c7881a0509717e71b34b63f31e40021c321f89ae04f84be6d6ac37",
			fee: BigNumber.make("10000000"),
			amount: BigNumber.make("1700000000"),
			expiration: 0,
			recipientId: "DBYyh2vXcigrJGUHfvmYxVxEqeH7vomw6x",
			signature:
		...
		},
		{
			...
			senderPublicKey: "03287bfebba4c7881a0509717e71b34b63f31e40021c321f89ae04f84be6d6ac37",
			fee: BigNumber.make("10000000"),
			amount: BigNumber.make("1500000000"),
			expiration: 0,
			recipientId: "DBYyh2vXcigrJGUHfvmYxVxEqeH7vomw6x",
			signature:
		...
		},
		{
			...
			senderPublicKey: "03287bfebba4c7881a0509717e71b34b63f31e40021c321f89ae04f84be6d6ac37",
			fee: BigNumber.make("10000000"),
			amount: BigNumber.make("1600000000"),
			expiration: 0,
			recipientId: "DBYyh2vXcigrJGUHfvmYxVxEqeH7vomw6x",
			signature:
		...
		},
		{
			...
			senderPublicKey: "03287bfebba4c7881a0509717e71b34b63f31e40021c321f89ae04f84be6d6ac37",
			fee: BigNumber.make("10000000"),
			amount: BigNumber.make("1200000000"),
			expiration: 0,
			recipientId: "DBYyh2vXcigrJGUHfvmYxVxEqeH7vomw6x",
			signature:
		...
		},
		{
			...
			senderPublicKey: "03287bfebba4c7881a0509717e71b34b63f31e40021c321f89ae04f84be6d6ac37",
			fee: BigNumber.make("10000000"),
			amount: BigNumber.make("1800000000"),
			expiration: 0,
			recipientId: "DBYyh2vXcigrJGUHfvmYxVxEqeH7vomw6x",
			signature:
		...
		},
		{
			...
			senderPublicKey: "03287bfebba4c7881a0509717e71b34b63f31e40021c321f89ae04f84be6d6ac37",
			fee: BigNumber.make("10000000"),
			amount: BigNumber.make("1400000000"),
			expiration: 0,
			recipientId: "DBYyh2vXcigrJGUHfvmYxVxEqeH7vomw6x",
			signature:
