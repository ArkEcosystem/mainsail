	...
	versions: {
		"2.5.24": {
			...
			scripts: {
				...
				"forger:devnet": "cross-env MAINSAIL_PATH_CONFIG=./bin/config/devnet yarn ark forger:run",
				"forger:mainnet": "cross-env MAINSAIL_PATH_CONFIG=./bin/config/mainnet yarn ark forger:run",
				"forger:testnet": "cross-env MAINSAIL_PATH_CONFIG=./bin/config/testnet yarn ark forger:run --env=test",
				"full:testnet": "cross-env MAINSAIL_PATH_CONFIG=./bin/config/testnet yarn ark core:run --env=test",
				prepack: "../../node_modules/.bin/oclif-dev manifest && npm shrinkwrap",
				postpack: "rm -f oclif.manifest.json",
				prepublishOnly: "yarn build",
				"relay:devnet": "cross-env MAINSAIL_PATH_CONFIG=./bin/config/devnet yarn ark relay:run",
				"relay:mainnet": "cross-env MAINSAIL_PATH_CONFIG=./bin/config/mainnet yarn ark relay:run",
				"relay:testnet": "cross-env MAINSAIL_PATH_CONFIG=./bin/config/testnet yarn ark relay:run --env=test",
				"start:devnet": "cross-env MAINSAIL_PATH_CONFIG=./bin/config/devnet yarn ark core:run",
				"start:mainnet": "cross-env MAINSAIL_PATH_CONFIG=./bin/config/mainnet yarn ark core:run",
				"start:testnet": "cross-env MAINSAIL_PATH_CONFIG=./bin/config/testnet yarn ark core:run --env=test",
			},
			dependencies: {
				"@mainsail/api": "^2.5.24",
				"@mainsail/blockchain": "^2.5.24",
				"@mainsail/container": "^2.5.24",
				"@mainsail/database-postgres": "^2.5.24",
				"@mainsail/core-event-emitter": "^2.5.24",
				"@mainsail/core-exchange-json-rpc": "^2.5.24",
				"@mainsail/forger": "^2.5.24",
				"@mainsail/logger-pino": "^2.5.24",
				"@mainsail/p2p": "^2.5.24",
				"@mainsail/core-snapshots": "^2.5.24",
				"@mainsail/state": "^2.5.24",
				"@mainsail/transaction-pool": "^2.5.24",
				"@mainsail/core-utils": "^2.5.24",
				"@mainsail/core-wallet-api": "^2.5.24",
				"@mainsail/webhooks": "^2.5.24",
				"@mainsail/crypto": "^2.5.24",
			...
			dist: {
				...
				tarball: "https://registry.npmjs.org/@mainsail/core/-/core-2.5.24.tgz",
				fileCount: 192,
				unpackedSize: 997808,
				"npm-signature":
	...
	versions: {
		"2.5.0-next.10": {
			...
			dependencies: {
				...
				"@mainsail/container": "^2.5.0-next.10",
				"@mainsail/database-postgres": "^2.5.0-next.10",
				"@mainsail/core-event-emitter": "^2.5.0-next.10",
				"@mainsail/core-exchange-json-rpc": "^2.5.0-next.10",
				"@mainsail/forger": "^2.5.0-next.10",
				"@mainsail/logger-pino": "^2.5.0-next.10",
				"@mainsail/p2p": "^2.5.0-next.10",
				"@mainsail/core-snapshots": "^2.5.0-next.10",
				"@mainsail/state": "^2.5.0-next.10",
				"@mainsail/transaction-pool": "^2.5.0-next.10",
				"@mainsail/core-utils": "^2.5.0-next.10",
				"@mainsail/core-wallet-api": "^2.5.0-next.10",
				"@mainsail/webhooks": "^2.5.0-next.10",
				"@mainsail/crypto": "^2.5.0-next.10",
				"@oclif/command": "^1.5.16",
				"@oclif/config": "^1.13.2",
				"@oclif/plugin-autocomplete": "^0.1.1",
				"@oclif/plugin-commands": "^1.2.2",
			...
			dist: {
				...
				tarball: "https://registry.npmjs.org/@mainsail/core/-/core-2.5.0-next.10.tgz",
				fileCount: 192,
				unpackedSize: 945581,
				"npm-signature":
			...
			_npmOperationalInternal: {
				...
				tmp: "tmp/MAINSAIL_2.5.0-next.10_1564479986828_0.13168983569100656",
			},
