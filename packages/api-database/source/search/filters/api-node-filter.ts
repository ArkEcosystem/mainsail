...
export class ApiNodeFilter {
    public static async getExpression(...criteria: Criteria.OrApiNodeCriteria[]): Promise<Expressions.Expression<ApiNode>> {
    ...
    private static async handleApiNodeCriteria(criteria: Criteria.ApiNodeCriteria): Promise<Expressions.Expression<ApiNode>> {
