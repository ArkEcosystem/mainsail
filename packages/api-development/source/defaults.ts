...
export const defaults = {
	plugins: {
		...
		rateLimit: {
			...
			enabled: Environment.getBoolean("CORE_API_DEV_RATE_LIMIT_DISABLED", false),
		...
		socketTimeout: 5000,
		trustProxy: Environment.getBoolean("CORE_API_DEV_TRUST_PROXY", false),
		whitelist: ["*"],
	},
	server: {
		http: {
			enabled: Environment.getBoolean("CORE_API_DEV_ENABLED"),
		...
		https: {
			enabled: Environment.getBoolean("CORE_API_DEV_SSL", false),
