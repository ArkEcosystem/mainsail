...
export class Aggregator implements Contracts.Consensus.IAggregator {
    ...
    public async aggregateMajorityPrevotes(roundState: Contracts.Consensus.IRoundState): Promise<Contracts.Crypto.IValidatorSetMajority> {
    ...
    public async aggregateMajorityPrecommits(roundState: Contracts.Consensus.IRoundState): Promise<Contracts.Crypto.IValidatorSetMajority> {
    ...
    public async getProposalLockProof(roundState: Contracts.Consensus.IRoundState): Promise<Contracts.Crypto.IProposalLockProof> {
    ...
    public async getProposedCommitBlock(roundState: Contracts.Consensus.IRoundState): Promise<Contracts.Crypto.ICommittedBlock> {
