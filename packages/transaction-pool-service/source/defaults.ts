...
export const defaults = {
	...
	enabled: !Environment.isTrue(Constants.EnvironmentVariables.CORE_TRANSACTION_POOL_DISABLED),
	...
	maxTransactionsInPool: Environment.get(Constants.EnvironmentVariables.CORE_MAX_TRANSACTIONS_IN_POOL, 15_000),
