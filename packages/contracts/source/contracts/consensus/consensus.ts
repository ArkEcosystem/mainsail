...
import { IAggregatedSignature, ICommittedBlockHandler, IPrecommit, IPrevote, IProposal } from "../crypto";
...
export interface IProposerPicker extends ICommittedBlockHandler {
