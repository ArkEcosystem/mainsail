import { ApplicationFactory, Commands, Contracts as CliContracts, InputParser, Plugins } from "@mainsail/cli";
...
export class CommandLineInterface {
	...
	public async execute(dirname?: string): Promise<void> {
		...
		await this.#app.get<CliContracts.Updater>(Identifiers.Cli.Service.Updater).logStatus();
