...
import { Command } from "@packages/core/source/commands/relay-stop";
...
describe("StopCommand", () => {
	...
	it("should throw if the process entered an unknown state", async () => {
		...
		await expect(cli.execute(Command)).rejects.toThrow('The "ark-relay" process has entered an unknown state.');
