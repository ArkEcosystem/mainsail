...
const checkV2Fields = (assert, deserialized: ITransaction, expected) => {
...
describe("Transaction serializer / deserializer", ({ it, assert, beforeAll }) => {
	beforeAll(() => {
		configManager.getMilestone().aip11 = true;
	});

	it.skip("signatures - should ser/deser single sing", () => {
		...
		checkV2Fields(assert, deserialized, transaction.data);
	});

	it.skip("signatures - should ser/deser second sign", () => {
		registerTransactionTypes(TestTransaction);
	...
	it.skip("signatures - should ser/deser multi sign", () => {
		registerTransactionTypes(TestTransaction);
	...
	it.skip("should ser/deser vendorField", () => {
		registerTransactionTypes(TestTransaction);
