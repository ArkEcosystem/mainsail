...
export interface WorkerScriptHandler {
    ...
    publicKeyFactory<K extends Requests<Contracts.Crypto.IPublicKeyFactory>>(method: K, ...args: Parameters<Contracts.Crypto.IPublicKeyFactory[K]>): Promise<ReturnType<Contracts.Crypto.IPublicKeyFactory[K]>>;
}
