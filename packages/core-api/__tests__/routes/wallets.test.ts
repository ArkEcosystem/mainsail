...
describe("Blockchain", () => {
	...
	describe("Transactions", () => {
		it("should be called", async () => {
			...
			const spyOnMethod = jest
				.spyOn(WalletsController.prototype, "transactions")
	...
	describe("Transactions Sent", () => {
		it("should be called", async () => {
			// @ts-ignore
			const spyOnMethod = jest
				.spyOn(WalletsController.prototype, "transactionsSent")
				.mockResolvedValue(paginatedResult);
	...
	describe("Transactions Received", () => {
		it("should be called", async () => {
			// @ts-ignore
			const spyOnMethod = jest
				.spyOn(WalletsController.prototype, "transactionsReceived")
				.mockResolvedValue(paginatedResult);
