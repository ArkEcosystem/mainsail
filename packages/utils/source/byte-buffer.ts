export class ByteBuffer {
	...
	public writeBytes(value: Buffer): void {
		if (value.length > this.getRemainderLength()) {
			throw new Error("Write over buffer boundary. (length: " + value.length + ", remaining: " + this.getRemainderLength() + ", diff: " + (value.length - this.getRemainderLength()) + ")");
		}
	...
	public readBytes(length: number): Buffer {
		if (length > this.getRemainderLength()) {
			throw new Error("Read over buffer boundary. (length: " + length + ", remaining: " + this.getRemainderLength() + ", diff: " + (length - this.getRemainderLength()) + ")");
		}
